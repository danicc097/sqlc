--- https://github.com/danicc097/sqlc/issues/604
CREATE TABLE users (
...
-- https://github.com/danicc097/sqlc/issues/1334
...
ALTER TABLE "users_2"
ADD FOREIGN KEY ("user_avatar_id") REFERENCES "media" ("media_id") ON DELETE
