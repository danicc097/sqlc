...
import (
	...
	"github.com/danicc097/sqlc/internal/codegen/sdk"
...
func postgresType(req *plugin.CodeGenRequest, col *plugin.Column) string {
	...
	emitPointersForNull := (driver == (SQLDriverPGXV4) || driver == (SQLDriverPGXV5)) && req.Settings.Go.EmitPointersForNullTypes
